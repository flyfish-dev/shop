...
public class EmailMagicLinkService {
    ...
    private String loginLink(String token) {
        String baseUrl = StringUtils.removeEnd(StringUtils.defaultIfBlank(properties.getBaseUrl(),
                "http://127.0.0.1:9999").trim(), "/");
