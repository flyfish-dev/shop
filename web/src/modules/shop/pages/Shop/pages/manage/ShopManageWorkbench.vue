...
const insightCards = computed(() => [
  { label: '商品分组', value: summary.value.groupCount },
  { label: '置顶商品', value: summary.value.pinnedItemCount },
  { label: '优惠券', value: `${summary.value.enabledCouponCount}/${summary.value.couponCount}` },
  { label: '代码仓库', value: `${summary.value.enabledRepositoryCount}/${summary.value.repositoryCount}` },
  { label: 'API Token', value: `${summary.value.enabledTokenCount}/${summary.value.tokenCount}` },
  { label: '注册用户', value: summary.value.userCount },
  { label: '待支付订单', value: summary.value.pendingPaymentCount },
  { label: '工单总数', value: summary.value.ticketTotal }
]);
  ...
  <div class="shop-manage-workbench">
    <section class="workbench-head">
      ...
      <div class="head-actions">
        ...
        <a-button type="primary" :loading="loading" @click="loadWorkbench">
