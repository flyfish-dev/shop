...
@media only screen and (max-width: 640px) {
  ...
  :deep(.ticket-drawer .ant-drawer-content-wrapper) {
    width: 100vw !important;
    max-width: 100vw;
  }

  :deep(.ticket-drawer .ant-drawer-content) {
    height: 100dvh;
    max-height: 100dvh;
  }

  :deep(.ticket-drawer .ant-drawer-body) {
    padding: 16px 12px max(18px, env(safe-area-inset-bottom));
  }

  :deep(.ticket-drawer .ant-row) {
    display: block;
  }

  :deep(.ticket-drawer .ant-col) {
    width: 100%;
    max-width: 100%;
  }
...
<style lang="less">
@media only screen and (max-width: 640px) {
  .ticket-drawer .ant-drawer-content-wrapper {
    width: 100vw !important;
    max-width: 100vw;
  }

  .ticket-drawer .ant-drawer-content {
    height: 100dvh;
    max-height: 100dvh;
  }
  ...
  .ticket-drawer .ant-row {
    display: block;
  }

  .ticket-drawer .ant-col {
    width: 100%;
    max-width: 100%;
  }
}
