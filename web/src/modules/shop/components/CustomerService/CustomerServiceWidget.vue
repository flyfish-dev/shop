...
const {
  ...
  loadActivities,
  startAutoRefresh: startActivityAutoRefresh,
  stopAutoRefresh: stopActivityAutoRefresh,
...
onMounted(() => {
  removeOpenListener = listenCustomerServiceOpen(handleOpenChat);
});
