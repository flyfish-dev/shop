  ...
  server: {
    ...
    proxy: {
      '/__lowcode': {
        ...
        ws: false,
        changeOrigin: true,
        rewrite: path => path.replace(/^\/__lowcode/, ''),
      },
      '/__shop': {
        target: 'http://localhost:10082',
        ws: false,
        changeOrigin: true,
        rewrite: path => path.replace(/^\/__shop/, ''),
      },
      '/integrity': {
        target: 'http://localhost:10081',
        // target: 'http://10.211.55.6:10081',
        // target: 'http://d.flyfish.group/',
        ws: false,
        changeOrigin: true,
      },
      '^/portal/users': {
      ...
      '^/portal/(customer-service|tickets|files)': {
        target: 'http://localhost:10082',
        ws: true,
        changeOrigin: true,
      },
