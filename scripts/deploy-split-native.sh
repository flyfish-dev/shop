...
SERVER="${FLYFISH_DEPLOY_SERVER:-root@example.com}"
BASE_DIR="${FLYFISH_DEPLOY_BASE_DIR:-/opt/flyfish-dev}"
PUBLIC_API_URL="${FLYFISH_PUBLIC_API_URL:-https://api.example.com}"
PUBLIC_WEB_URL="${FLYFISH_PUBLIC_WEB_URL:-https://shop.example.com}"
...
install_runtime_files() {
  ssh "$SERVER" "mkdir -p '$BASE_DIR/scripts'"
