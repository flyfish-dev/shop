...
class SupportTicketServiceImplTest {
    ...
    private static class Fixture {
        ...
        private final SupportTicketServiceImpl service = new SupportTicketServiceImpl(ticketRepository,
                messageRepository, authUserGateway, notificationService, realtimeNotifier);
        ...
        private Fixture() {
            ...
            when(authUserGateway.getById(1L)).thenReturn(Mono.empty());
        ...
        private PortalUserVo maintainer() {
            ...
            user.setAuthorizations(Map.of("gitea", oauth(1L, OAuthType.GITEA, "1",
                    "{\"id\":\"1\",\"login\":\"wybaby168\"}", "wybaby168")));
            return user;
        }

        private PortalUserOauthVo oauth(Long userId, OAuthType type, String openid, String userInfo,
                                        String loginName) {
            return PortalUserOauthVo.of(userId, type, openid, userInfo, null, loginName, loginName,
