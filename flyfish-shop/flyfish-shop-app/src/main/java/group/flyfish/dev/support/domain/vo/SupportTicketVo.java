...
public class SupportTicketVo {
    ...
    public SupportTicketVo(SupportTicket ticket, PortalUserVo creator) {
        this(ticket, creator, false);
    }

    public SupportTicketVo(SupportTicket ticket, PortalUserVo creator, boolean managerView) {
    ...
    private static String creatorName(PortalUserVo creator, Long fallbackId) {
        if (creator == null) {
