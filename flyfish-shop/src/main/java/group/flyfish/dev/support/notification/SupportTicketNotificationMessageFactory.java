...
public class SupportTicketNotificationMessageFactory {
    ...
    public SupportTicketNotificationMessage userTicketCreated(SupportTicket ticket, PortalUser creator) {
    ...
    public SupportTicketNotificationMessage userTicketResolved(SupportTicket ticket, PortalUser creator) {
