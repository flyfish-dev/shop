...
public class SupportTicketServiceImpl implements SupportTicketService {
    ...
    private Mono<SupportTicketDetailVo> toDetail(SupportTicket ticket, boolean managerView) {
        Mono<Optional<PortalUser>> creator = findUser(ticket.getCreatorId());
    ...
    private SupportTicketMessageVo toMessageVo(SupportTicketMessage message, PortalUser creator) {
