...
public class CustomerWechatActivityServiceImpl implements CustomerWechatActivityService {
    ...
    private CustomerWechatActivity buildActivity(WechatInboundMessage message, String rawXml,
                                                 Optional<PortalUserOauth> oauth) {
    ...
    private void applyIdentity(CustomerWechatActivity activity, Optional<PortalUserOauth> optional) {
        if (optional.isEmpty()) {
        ...
        activity.setUserId(oauth.getUserId());
