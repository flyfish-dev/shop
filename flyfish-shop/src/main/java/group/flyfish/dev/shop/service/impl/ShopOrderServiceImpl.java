...
public class ShopOrderServiceImpl implements ShopOrderService {
    ...
    private Mono<ShopOrder> deliverIfNeeded(ShopOrder order) {
        ...
        return Mono.zip(shopItemRepository.findById(order.getItemId()), portalUserService.getById(order.getBuyerId()))
    ...
    private Mono<ShopOrderVo> toVo(ShopOrder order, ShopItem item) {
        ...
        return portalUserService.getById(order.getBuyerId())
                .doOnNext(buyer -> {
