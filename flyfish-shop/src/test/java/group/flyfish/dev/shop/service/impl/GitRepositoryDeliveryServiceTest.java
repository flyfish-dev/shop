...
class GitRepositoryDeliveryServiceTest {
    ...
    private PortalUserVo githubBuyer() {
        ...
        user.setId(100L);
        user.setAuthorizations(Map.of("github", new PortalUserOauthVo(oauth)));
        return user;
    }

    private PortalUserVo mixedBuyer() {
        PortalUserOauth githubOauth = new PortalUserOauth();
        githubOauth.setType(OAuthType.GITHUB);
        githubOauth.setOpenid("1");
        githubOauth.setUserInfo("""
                {"id":"1","login":"octocat","name":"Mona"}
                """);

        PortalUserOauth giteaOauth = new PortalUserOauth();
        giteaOauth.setType(OAuthType.GITEA);
        giteaOauth.setOpenid("2");
        giteaOauth.setUserInfo("""
        ...
        user.setAuthorizations(Map.of(
                "github", new PortalUserOauthVo(githubOauth),
                "gitea", new PortalUserOauthVo(giteaOauth)
        ));
        return user;
    }
